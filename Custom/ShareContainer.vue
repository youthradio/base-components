  ...
  <div class="fixed-ns mv5-ns flex-s top-2-ns ">
    <div class="">
      <a
        ...
        "
      >
        <svg class="db pa2" height="20" viewBox="0 0 12 24" fill="none">
          <path
      ...
      <a
        ...
        "
      >
        <svg class="db pa2" height="20" viewBox="0 0 24 20" fill="none">
          <path
      ...
      <a
        ...
        "
      >
        <svg class="db pa2" height="20" viewBox="0 0 24 18" fill="none">
          <path
