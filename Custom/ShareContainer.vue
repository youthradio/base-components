  ...
  <aside>
    <div class="">
      <a
        ...
        "
      >
        <svg class="" width="12" height="24" viewBox="0 0 12 24" fill="none">
          <path
      ...
      <a
        ...
        "
      >
        <svg class="" width="24" height="20" viewBox="0 0 24 20" fill="none">
          <path
      ...
      <a
        ...
        "
      >
        <svg class="" width="24" height="18" viewBox="0 0 24 18" fill="none">
          <path
